...
@ReactModule(name = NativePlatformConstantsAndroidSpec.NAME, canOverrideExistingModule = true)
@SuppressLint("HardwareIds")
class PlatformConstantsCompatModule(
  ...
  override fun getTypedExportedConstants(): Map<String, Any?> {
    ...
    if (ReactBuildConfig.DEBUG) {
      constants["ServerHost"] = reactApplicationContext.sourceURL
    }
  ...
  override fun getAndroidID(): String =
      Secure.getString(reactApplicationContext.contentResolver, Secure.ANDROID_ID)

  override fun invalidate() {}

  private fun uiMode(): String {
    val uiModeManager =
        reactApplicationContext.getSystemService(UI_MODE_SERVICE) as UiModeManager
